...
namespace DemoInGitSSL
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // And start the server with SSL (https).
            var certificate = new X509Certificate(@"C:\Users\byh\openssl\byhServer.pfx", "1234qwer");
            var server = new HttpServer(moduleManager);
            server.Start(IPAddress.Any, 0, certificate);
